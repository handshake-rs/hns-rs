...
use hns_p2p_experimental::{
    ATOMIC_MARKET_PROTOCOL_ID, CANCEL_MARKET_INTENT_MESSAGE_TYPE, CROSS_CHAIN_MARKET_MAX_PAYLOAD,
    CROSS_CHAIN_MARKET_PROTOCOL_ID, DENUO_V1_REGISTRY_VERSION, DENUO_V2_REGISTRY_VERSION,
    DenuoExtensionEnvelope, FILL_GRANT_MESSAGE_TYPE, GET_MARKET_INTENT_MESSAGE_TYPE,
...
pub const NAME_MARKET_PROTOCOL_VERSION: u16 = 1;
